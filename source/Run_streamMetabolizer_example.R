...
#setwd("C:/Users/dixon/OneDrive - USNH/Research/Metabolism/Alice Carter")
...
air_press_temp <- read.csv('./data/alice_carter/air_pressure_temp.csv')


# prep raw data file for running metabolism -------------------------------####
dat <- read.csv('./data/alice_carter/cleaned_DO_data.csv')
